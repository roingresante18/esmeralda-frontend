      ...
      >
        ...
        {trackingUrl && (
          <>
            ...
            <Stack spacing={0.6}>
              <Typography fontWeight={600} sx={{ color: "#1b8f2f" }}>
                <FaLink /> Seguimiento del pedido
              </Typography>

              <Typography variant="body2">
                Consultá el estado de tu pedido desde:
              </Typography>
              ...
              <Typography fontSize={10.5} color="text.secondary">
                Por seguridad, al ingresar se solicitarán los últimos 4 dígitos
                del teléfono asociado al pedido.
              </Typography>
            </Stack>
          </>
        )}
